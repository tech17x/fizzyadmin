...
const Menu = () => {
    ...
    const fetchAllMenus = async () => {
        try {
            const res = await axios.get("http://localhost:5001/api/menus/accessible", {
    ...
    const handleEditCategory = (menu) => {
        ...
        handleBrandSelection(menu.brand_id);
    ...
    const handleSave = async () => {
        ...
        try {
            if (isEditing) {
                ...
                await axios.put(`http://localhost:5001/api/menus/update/${menuId}`, payload, { withCredentials: true });
                toast.success("Category updated successfully");
            } else {
                await axios.post("http://localhost:5001/api/menus/create", payload, { withCredentials: true });
    ...
    return (
        <>
            ...
            <SearchFilterBar
                placeholder="Search Brand, Outlet, Menu..."
                searchValue={search}
