                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">Configure WhatsApp Business API credentials</p>
                                </div>
                                <button 
                                    onClick={handleAdd}
                                    className="bg-gradient-to-r from-green-400 to-green-500 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center gap-2"
                                >
