                ...
                true ?
                    <div className="menu">
                        ...
                        <div className="add-new-staff-info">
                            <GradientButton>Add Menu</GradientButton>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Calgary</td>
                                            <td>Downtown</td>
                                            <td className='center-div'><div className="status active">Yes</div></td>
                                            <td className='center-div'><div className="status active">Yes</div></td>
                                            <td className='center-div'><div className="status active">Yes</div></td>
                                            <td className='center-div'><div className="status active">Active</div></td>
                                            <td>2024-04-04 20:53:15</td>
                                            <td>
                        ...
                        <div className="row">
                            ...
                            <div>
                                <InputField
                                    ...
                                    required
                                />
                                <GradientButton>Upload</GradientButton>
                            </div>
                        </div>
