...
const Table = () => {
    ...
    const { tables, loading, createTable, updateTable } = useTables();
    ...
    const fetchFloorsShort = async () => {
        try {
            const response = await axios.get("http://localhost:5001/api/floors/staff-floors/shorts", {
                    ...
                    <div className="inputs-container">
                        ...
                        <div className="inputs-row">
                            <SelectInput
                                ...
                                options={floors.map(f => ({ label: f.floor_name, value: f._id }))}
                            />
                            <InputField
                                label="Table Name"
                                type="text"
