...
const Categories = () => {
    ...
    const fetchAllCategories = async () => {
        try {
            const res = await axios.get("http://localhost:5001/api/categories/accessible", {
    ...
    const handleSave = async () => {
        ...
        try {
            if (isEditing) {
                ...
                await axios.put(`http://localhost:5001/api/categories/update/${categoryId}`, payload, { withCredentials: true });
                toast.success("Category updated successfully");
            } else {
                await axios.post("http://localhost:5001/api/categories/create", payload, { withCredentials: true });
