...
const CardAdd = ({ handleAdd }) => {
    return (
        <button 
            className="card border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50 transition-all duration-300 min-h-[200px] flex flex-col justify-center items-center text-center group p-6"
            onClick={handleAdd}
        >
