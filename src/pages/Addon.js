...
const Addon = () => {
    ...
    const handleDeleteAddon = async (id) => {
        ...
        setLoading(true);
        try {
            await axios.delete(`${API}/api/addons/delete/${id}`, {
                withCredentials: true,
            });
                    ...
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    <h2 className="text-xl font-bold text-gray-800">Add-on Management</h2>
                                    <p className="text-gray-600 mt-1">Configure additional items and extras</p>
                                </div>
                                <button 
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <div className="tax-action-btns">
                                                            ...
                                                            {/* onclick dte the addon  */}
                                                            <button onClick={() => handleDeleteAddon(item._id)}>
