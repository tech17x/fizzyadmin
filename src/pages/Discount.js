...
const Discount = () => {
    ...
    const fetchOrderTypes = async () => {
        try {
            const response = await axios.get("http://localhost:5002/api/order-type/accessible", {
