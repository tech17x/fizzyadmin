        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div>
                    ...
                    <p className="text-gray-600">Manage and configure your {title.toLowerCase()}</p>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            className="pl-12 pr-12 py-3 w-80 border border-gray-300 rounded-lg text-sm placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                    ...
                    <div className="relative">
                        <button
                            className="flex items-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 text-sm font-medium min-w-[140px]"
                            onClick={() => setShowFilterDropdown(!showFilterDropdown)}
                        >
                            <Filter className="w-4 h-4 text-gray-500" />
                            <span className="text-gray-700">{getLabel(selectedFilter)}</span>
                                ...
                                {filterOptions.map(({ label, value }) => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 text-sm hover:bg-gray-50 transition-colors flex items-center justify-between ${
                                            selectedFilter === value ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-700'
                                        }`}
