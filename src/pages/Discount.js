...
const Discount = () => {
    ...
    const handleEdit = async (data) => {
        ...
        setRate(data.rate ?? 0);
        setSelectedDay(weeks.find(i => i.value === data.day) ?? null);
    ...
    const handleSave = async () => {
        ...
        if (!selectedBrand || !selectedOutlet || !name || !selectedApplyAs || !applyType || !rate || (!couponCode && applyType?.value === "coupon")) {
